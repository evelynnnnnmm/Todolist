...
export function Layout({ children }: LayoutProps) {
  return (
    <div className="paper-shell min-h-screen text-stone-950">
      <header className="border-b border-stone-200 bg-[#fffdf7]/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          <div className="flex items-center gap-3">
            <svg
              className="hidden h-12 w-16 sm:block"
              viewBox="0 0 128 88"
              role="img"
            ...
            >
              ...
              <path d="M61 58c3 2 6 2 9 0" stroke="#111827" strokeWidth="2" fill="none" strokeLinecap="round" />
              <path d="M104 57c11-10 18 4 7 11" stroke="#111827" strokeWidth="5" fill="none" strokeLinecap="round" />
              <path d="M68 69v8M91 69v8" stroke="#111827" strokeWidth="5" strokeLinecap="round" />
              <path d="M53 75h54" stroke="#111827" strokeWidth="3" strokeLinecap="round" />
            </svg>
            <div>
                ...
                className={({ isActive }) =>
                  [
                    ...
                    isActive
                      ...
                      : 'text-stone-600 hover:bg-red-50 hover:text-stone-950',
                  ].join(' ')
                }
              >
                {item.label}
